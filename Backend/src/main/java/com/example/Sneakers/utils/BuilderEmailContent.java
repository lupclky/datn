...
public class BuilderEmailContent {
    public static String buildOrderEmailContent(Order order) {
        ...
        content.append("<h1>Đặt hàng thành công từ Locker Korea - Đơn hàng #" + order.getId() + "</h1>");
        content.append("<p>Chào " + order.getFullName() + ",</p>");
        content.append("<p>Chúng tôi xin gửi lời cảm ơn chân thành đến bạn vì đã đặt tủ tại Locker Korea.</p>");
        ...
        content.append("<p>Locker Korea</p>");
